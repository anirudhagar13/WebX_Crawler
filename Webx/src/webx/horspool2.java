...
public class horspool2
{
    public int search(String bodyText, String searchWord, String currentUrl, int urlNum)
    {
        ...
        //System.out.println("modified bodyText is = "+modifiedBodyText);
        ...
        {
            int k =0;
            while(k <= m-1 && searchWord.charAt(m-1-k) == bodyText.charAt(i-k))
            {
                k = k + 1;  
            }
            if(k == m)
    ...
    public static void printToFile1(String text, int fileNum)
    {
        try
        {
            String filename = "C:\\Users\\ABC\\Desktop\\files\\currentLine";
        	//String filename = "C:\\Users\\Rohan\\Desktop\\Project\\web_crawler\\src\\currentLine";
            String FileNum = fileNum + "";
            String modifiedFileName = filename + FileNum;
            BufferedWriter bw = null;
            bw = new BufferedWriter(new FileWriter(modifiedFileName, true));
            //bw.write("This is line number " + freq+" : ");
            //bw.newLine();
            bw.write(text);
            bw.newLine();
            bw.write("********************************");
    ...
    public static void printToFile2(int x, int y, int fileNum)
    {
        try
        {
            //String filename = "C:\\Users\\Rohan\\Desktop\\Project\\Files\\numOfLines";
        	String filename = "C:\\Users\\ABC\\Desktop\\files\\numOfLines";
            String FileNum = fileNum + "";
            String modifiedFileName = filename + FileNum;
            BufferedWriter bw = null;
            bw = new BufferedWriter(new FileWriter(modifiedFileName, true));
            //bw.write("URL OF VISITING PAGE = "+url);
            //bw.write("The number of lines before this are = "+x);
