...
public class SpiderLeg {
	...
	public boolean crawl(String url) {
		try {
			...
			System.out.println("No. Of Links on this Page = "
					+ linksOnPage.size()); // Number Of Links Found in a Page.
	...
	public int searchForWord(String searchWord, String currentUrl, int urlNum) {
		...
		String bodyText = this.htmlDocument.body().text(); // Converts HTML BODY
															// to a Single
															// String.
